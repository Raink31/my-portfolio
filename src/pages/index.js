    ...
    <div className={homeStyles.container}>
      ...
      <main className={homeStyles.main}>
        <div className={homeStyles.presentation}>
          ...
          <p>Hi there! My name is <strong>Yohan</strong>, I am a self-taught developer based in France, and I like to create beautiful interfaces with excellent usability.</p>
          <br />
